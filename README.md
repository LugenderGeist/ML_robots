...
Перебор гиперпараметров позволил найти конфигурацию, обеспечивающую наилучший компромисс между точностью и устойчивостью модели.
Использование GridSearchCV с оптимизацией по F1-score является правильным подходом для несбалансированных выборок.
